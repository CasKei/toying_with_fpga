...
module dice_2 (
  ...
  edge_detector_6 edge_seed (
    .clk(clk),
    .in(M_edge_seed_in),
    .out(M_edge_seed_out)
  );
  reg [1:0] M_seed_d, M_seed_q = 1'h0;
  reg [2:0] M_numhold_d, M_numhold_q = 1'h0;
  wire [10-1:0] M_slowerclock_value;
  counter_7 slowerclock (
    .clk(clk),
    .rst(rst),
  ...
  always @* begin
    ...
    M_numhold_d = M_random_number_num[0+2-:3];
